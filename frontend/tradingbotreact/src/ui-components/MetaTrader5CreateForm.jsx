...
import { createMetaTrader5 } from "../graphql/mutations";
const client = generateClient();
export default function MetaTrader5CreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMetaTrader5.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MetaTrader5CreateForm")}
      {...rest}
    >
      <TextField
